...
/*   Updated: 2025/07/30 00:49:02 by wnid-hsa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void status_handling_chid(int *pid, 
...
static void status_handling(int status_1)
{
    ft_signals(1);
...
static int outfiles_checking(t_tree * tree)
{
    int fd;
